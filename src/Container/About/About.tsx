    ...
    <>
      <div className="h-[100%] w-full flex flex-col justify-between">
        ...
        <div className="flex w-full h-[78%] justify-between items-start">
          <div className="flex w-[38%] sm:w-[40%] sm:h-[70%] h-full justify-center">
            <div className=" h-[80%] profile w-[95%] rounded-[30px] rotate-[-1deg]">
              <div
                style={{
                  background: `url(${Image.Profile})`,
          ...
          <div className="w-[50%] h-full flex flex-col justify-between">
                ...
                return (
                  <>
                    <AboutCard
                      cardBehaviour={{
                        detail: obj,
                        detailStyle: "text-[#767685] font-semibold text-[13px] sm:text-[10px]",
                        style: `w-[45%] h-[100%] flex flex-col 
                          justify-evenly items-center rounded-[15px] 
                          bg-[#2c2c6c] text-white font-semibold text-[16px] 
            ...
            <div className="h-[50%] text-justify text-[#9F9FA9] text-[17px] sm:text-[10px] font-semibold leading-7 sm:leading-4">
